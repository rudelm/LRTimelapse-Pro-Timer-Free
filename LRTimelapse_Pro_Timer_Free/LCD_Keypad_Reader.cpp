...
// I've used the values from my LCD Keypad Shield. To check out your values check
// https://gist.github.com/rudelm/463c59a218a4c17fdad8228356446f8b

static int UPKEY_ARV = 131; // 0.720 V, that's read "analogue read value" 
static int DOWNKEY_ARV = 308; // 1.645 V 
static int LEFTKEY_ARV = 481; // 2.525 V 
static int RIGHTKEY_ARV = 0; // 0 V 
static int SELKEY_ARV = 723; // 3.710 V 
